...
```bash
ansible-vault encrypt playbook/group_vars/deb.yml --vault-password-file <(echo netology)
ansible-vault encrypt playbook/group_vars/el.yml --vault-password-file <(echo netology)
```
