...
```bash
ansible-vault encrypt /root/playbook/group_vars/deb.yml --vault-password-file <(echo netology)
ansible-vault encrypt /root/playbook/group_vars/el.yml --vault-password-file <(echo netology)
```
